...
}const entities=(_pluralize=(0,pluralize/* pluralize */.t)(props.pageContext.entityName))!==null&&_pluralize!==void 0?_pluralize:'Articles';return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(Seo/* Seo */.G,{title:`All ${entities}`,useTitleTemplate:true}),/*#__PURE__*/index_js_default().createElement(Page/* Page */.Y,null,/*#__PURE__*/index_js_default().createElement(Section/* Section */.w,{anchor:"articleListing",heading:entities},/*#__PURE__*/index_js_default().createElement("div",{className:Filter},"Select categories to filter ",entities.toLocaleLowerCase(),/*#__PURE__*/index_js_default().createElement(Slider/* Slider */.A,{additionalClasses:[Options]},filterOptions.map((option,key)=>{return/*#__PURE__*/index_js_default().createElement("div",{key:key,role:"button",onClick:()=>handleFilterOptionClick(option.label),className:[Option,option.selected===true?Selected:null].join(' ')},option.label," (",option.relatedArticleIds.length,")");}))),/*#__PURE__*/index_js_default().createElement("div",{className:Listing},articles.filter(article=>!filterSelected||selectedArticleIds.includes(article.id)).slice(0,shownArticlesNumber).map((article,key)=>{return/*#__PURE__*/index_js_default().createElement(ArticleCard/* ArticleCard */.d,{key:key,showBanner:true,data:{image:article.banner,title:article.title,category:article.categories.join(' / '),publishedAt:new Date(article.date.replace(/-/g,'/')),link:article.slug,readingTime:article.readingTime.text}});})),filterSelected&&selectedArticleIds.length>shownArticlesNumber||!filterSelected&&articles.length>shownArticlesNumber?/*#__PURE__*/index_js_default().createElement("div",{className:LoadMore},/*#__PURE__*/index_js_default().createElement(Button/* Button */.$,{type:Button/* ButtonType */.V.BUTTON,label:"Load More",onClickHandler:()=>setShownArticlesNumber(prev=>prev+6)})):null)));}// Helper function to calculate a sorted array of filter options based on the given articles
...
const absoluteUrl=props.data.link.indexOf('://')>0||props.data.link.indexOf('//')===0;const articleCard=/*#__PURE__*/index_js_default().createElement("article",{className:Card,style:darkModeEnabled?{border:'0.125rem solid var(--primary-color)'}:undefined},props.showBanner&&/*#__PURE__*/index_js_default().createElement("div",{className:Banner},props.data.image&&props.data.image.src&&/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{className:ImageWrapper,imgClassName:Image,objectFit:props.data.image.objectFit||'cover',image:props.data.image.src.childImageSharp.gatsbyImageData,alt:props.data.image.alt||props.data.title})),/*#__PURE__*/index_js_default().createElement("div",{className:DescriptionWrapper},/*#__PURE__*/index_js_default().createElement("span",{className:Category},/*#__PURE__*/index_js_default().createElement("u",null,props.data.category)),/*#__PURE__*/index_js_default().createElement("h4",{className:Title},props.data.title),/*#__PURE__*/index_js_default().createElement("div",{className:Details},formatDate(props.data.publishedAt),props.data.readingTime&&/*#__PURE__*/index_js_default().createElement("span",{className:ReadingTime},props.data.readingTime))));return absoluteUrl?/*#__PURE__*/index_js_default().createElement("a",{href:props.data.link,target:"_blank",rel:"noopener noreferrer",title:props.data.title},articleCard):/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:props.data.link,title:props.data.title},articleCard);}function ArticleCardSkeleton(){const{globalState}=useGlobalState();const darkModeEnabled=globalState.theme===Theme.Dark;return/*#__PURE__*/React.createElement("div",{className:classes.Card,style:darkModeEnabled?{border:'0.125rem solid var(--primary-color)'}:undefined},/*#__PURE__*/React.createElement("div",{className:classes.DescriptionWrapper},/*#__PURE__*/React.createElement(SkeletonLoader,{style:{height:'1.5rem',marginBottom:'.5rem',background:'var(--tertiary-color)'}}),/*#__PURE__*/React.createElement(SkeletonLoader,{style:{height:'4rem',background:'var(--tertiary-color)'}}),/*#__PURE__*/React.createElement(SkeletonLoader,{style:{height:'.75rem',width:'50%',marginTop:'.5rem',background:'var(--tertiary-color)'}})));}function formatDate(date){const months=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];return`${months[date.getMonth()]} ${date.getDate()}, ${date.getFullYear()}`;}
