...
/* harmony export */   QN: () => (/* binding */ useGlobalState),
/* harmony export */   Sx: () => (/* binding */ Theme),
/* harmony export */   X2: () => (/* binding */ ActionType),
/* harmony export */   Y2: () => (/* binding */ GlobalStateProvider)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3380);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_useMediaQuery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3323);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Q: () => (/* binding */ useSiteMetadata)
/* harmony export */ });
...
function SplashScreen_SplashScreen(){const[shouldUnmount,setShouldUnmount]=index_js_default().useState(false);const{dispatch}=(0,context/* useGlobalState */.QN)();return/*#__PURE__*/index_js_default().createElement(Animation/* Animation */.X,{className:SplashScreen,type:shouldUnmount===false?'fadeIn':'fadeOut',duration:250,fillMode:"forwards",onAnimationEnd:()=>{if(shouldUnmount)dispatch({type:context/* ActionType */.X2.SetSplashScreenDone,value:true});}},/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{class:'fixed'}}),/*#__PURE__*/index_js_default().createElement("div",{className:LogoWrapper},/*#__PURE__*/index_js_default().createElement(Animation/* Animation */.X,{className:Backdrop,type:"reduceHeight",delay:800,fillMode:"forwards",onAnimationEnd:()=>{// Wait 500ms and start unmounting the splash screen
setTimeout(()=>{setShouldUnmount(true);},500);}}),/*#__PURE__*/index_js_default().createElement(Logo,{fontSize:"3rem",color:"var(--background-color)",theme:context/* Theme */.Sx.Dark})));}
...
function Layout_Layout(props){const location=(0,index_modern.useLocation)();const{globalState}=(0,context/* useGlobalState */.QN)();const{0:isInternalNavigation,1:setIsInternalNavigation}=(0,index_js_.useState)(false);const showSplashScreen=!isInternalNavigation&&props.useSplashScreenAnimation&&!globalState.splashScreenDone;const darkModeEnabled=globalState.theme===context/* Theme */.Sx.Dark;(0,index_js_.useLayoutEffect)(()=>{const referrer=location.state&&location.state.referrer!==null;setIsInternalNavigation(!!referrer);},[]);const splashScreenView=/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{'data-theme':context/* Theme */.Sx.Light}}),/*#__PURE__*/index_js_default().createElement(SplashScreen_SplashScreen,null));const layoutView=/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{'data-theme':darkModeEnabled?context/* Theme */.Sx.Dark:context/* Theme */.Sx.Light}}),/*#__PURE__*/index_js_default().createElement("div",{className:Layout},/*#__PURE__*/index_js_default().createElement(Header_Header,null),/*#__PURE__*/index_js_default().createElement("main",null,props.children),/*#__PURE__*/index_js_default().createElement(Footer_Footer,null),props.useCookieBar?/*#__PURE__*/index_js_default().createElement(CookieBar_CookieBar,null):/*#__PURE__*/index_js_default().createElement(EnsureActivatedTrackingCookie,null)));return showSplashScreen?splashScreenView:layoutView;}
;// ./node_modules/gatsby-theme-portfolio-minimal/src/components/Page/index.tsx
function Page(props){const siteConfiguration=useSiteConfiguration();return/*#__PURE__*/index_js_default().createElement(context/* GlobalStateProvider */.Y2,{defaultTheme:siteConfiguration.featureToggles.useDarkModeAsDefault?context/* Theme */.Sx.Dark:context/* Theme */.Sx.Light,useDarkModeBasedOnUsersPreference:siteConfiguration.featureToggles.useDarkModeBasedOnUsersPreference,useSplashScreenAnimation:props.useSplashScreenAnimation||false},/*#__PURE__*/index_js_default().createElement(Layout_Layout,{useSplashScreenAnimation:props.useSplashScreenAnimation||false,useCookieBar:siteConfiguration.featureToggles.useCookieBar},props.children));}
...
!(function () {
  ...
  !(function () {
    ...
    const e = __webpack_require__(3380);
    var t = n.n(e),
      r = n(697),
      i = n.n(r),
      c = n(808),
